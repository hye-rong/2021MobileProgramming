            ...
            loginBtn.setOnClickListener{
                ...
                rdb.addListenerForSingleValueEvent(object : ValueEventListener {
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        ...
                        if(idFlag){
                            rdb.child(userID.text.toString()).addListenerForSingleValueEvent(object : ValueEventListener {
                                override fun onCancelled(p0: DatabaseError) {
                                }
                                override fun onDataChange(p0: DataSnapshot) {
                                    for (snapshot in p0.children) {
                            ...
                            Toast.makeText(this@UserLogin, "회원가입이 필요합니다", Toast.LENGTH_SHORT).show()
                            userID.text.clear()
                            userPW.text.clear()
                        }
                    }
